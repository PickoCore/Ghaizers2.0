    ...
    <>
      ...
      <div style={{ fontFamily: "var(--f-body,DM Sans,sans-serif)", background: "var(--s0,#020508)", color: "var(--t1,#e2e8f0)", minHeight: "100vh" }}>
        ...
        <nav style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"0 24px", height:56, background:"rgba(2,5,8,0.9)", backdropFilter:"blur(20px)", borderBottom:"1px solid rgba(255,255,255,0.06)", position:"sticky", top:0, zIndex:100 }}>
          <a href="/" style={{ fontFamily:"var(--f-display,Syne,sans-serif)", fontWeight:800, fontSize:16, color:"var(--teal,#2dd4bf)", textDecoration:"none", display:"flex", alignItems:"center", gap:10 }}>
          ...
          <a href="/" style={{ fontSize:13, color:"var(--t2,#94a3b8)", textDecoration:"none", padding:"6px 14px", borderRadius:8, border:"1px solid rgba(255,255,255,0.08)" }}>
            ← Kembali
          </a>
        </nav>
        ...
        <div style={{ textAlign:"center", padding:"24px", borderTop:"1px solid rgba(255,255,255,0.06)", fontSize:12, color:"rgba(148,163,184,0.5)" }}>
          © 2025–2026 ghaa (KhaizenNomazen) · <a href="/terms" style={{ color:"var(--teal,#2dd4bf)", textDecoration:"none" }}>Terms of Service</a> · <a href="/" style={{ color:"inherit", textDecoration:"none" }}>optimizer.ghaa.my.id</a>
        </div>
      </div>
    </>
  );
